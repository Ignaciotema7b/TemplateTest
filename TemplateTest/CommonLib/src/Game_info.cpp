...
void Game_info::load_info(string path)
{
    ...
    string str; //Ac� voy a guardar lo que leo del archivo.
    getline(archivo, str, '\n');//La funci�n getline lee con tres par�metros(de que archivo,donde lo guardo,hasta donde leo).

    //La funci�n str.find(",") lee el str y guarda el lugar donde encuentre una coma.
